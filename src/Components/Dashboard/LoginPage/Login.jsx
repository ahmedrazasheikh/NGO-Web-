...
const Login = () => {
  ...
  const validCredentials = [
    ...
    { username: 'Naqi Dossa', password: 'S3cur3P@ssw0rd2' },
    { username: 'Maulana Bahishti', password: 'My$tr0ngP@ssw0rd3' },
  ];
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900">
      ...
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
        ...
        <form className="space-y-4 md:space-y-6 p-12" onSubmit={handleLogin}>
                  <div>
                      <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email</label>
                      <input   onChange={(e)=>setEmail(e.target.value)} type="text" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required=""/>
                  </div>
                  <div>
