...
const Edit_Complete = () => {
  ...
  const deleteData = async (id)=>{
    try {
      const response = await axios.delete(`https://busy-tan-dhole-wig.cyclic.app/api/v1/customer2/${id}`)
  ...
  return (
    <>
    <h1 className="text-4xl text-center my-4 mb-6">Edit Completed Project </h1>
