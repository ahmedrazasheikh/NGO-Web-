...
<div class="end-card md:mr-6 mr-0  animate-from-bottom w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 rounded overflow-hidden shadow-lg mb-4">
  <img class="w-full h-64" src={img1} alt="Sunset in the mountains" />
  <div class="px-6 py-4">
...
<div class="end-card md:mr-6 mr-0  animate-from-bottom w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 rounded overflow-hidden shadow-lg mb-4">
  <img class="w-full h-64" src={img2} alt="Sunset in the mountains" />
  <div class="px-6 py-4">
...
<div class="end-card md:mr-6 mr-0  animate-from-bottom w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 rounded overflow-hidden shadow-lg mb-4">
  <img class="w-full h-64" src={img3} alt="Sunset in the mountains" />
  <div class="px-6 py-4">
