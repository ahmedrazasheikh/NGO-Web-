...
const Nested_Active_Project = () => {
  ...
  return (
    <>
       <Header/>
       <Slider/>
       <h1 className='font-extrabold text-3xl my-4 	 text-center	'>{CategoryName} Active  Projects</h1>
...
export default Nested_Active_Project